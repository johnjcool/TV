...
public class LiveChannelsTunerSetupActivity extends BaseTunerSetupActivity {
    private static final String TAG = "LiveChannelsTunerSetupActivity";
    ...
    protected void executeGetTunerTypeAndCountAsyncTask() {
        new AsyncTask<Void, Void, Integer>() {
            ...
            protected Integer doInBackground(Void... arg0) {
                return TunerHal.getTunerTypeAndCount(LiveChannelsTunerSetupActivity.this).first;
            }

            @Override
            protected void onPostExecute(Integer result) {
                if (!LiveChannelsTunerSetupActivity.this.isDestroyed()) {
                    mTunerType = result;
                    if (result == null) {
                        finish();
